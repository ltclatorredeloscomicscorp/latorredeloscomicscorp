...
<body>
	<div id="inicio">
		...
		<div id="contenido">
			...
			<div id="info_us" style="position:relative;margin-left: 55%;color: white;width: 40%;pading: 20px;	overflow: hidden;margin-top:-200px;margin-bottom: 150px;font-family: 'Oswald', sans-serif;">Tienda especializada en la venta de comics, articulos de colección y afines.
categories</div>
		</div>
	</div>
