...
public class AccessController {
	...
	public static boolean  isPermitedMessage (String url, HttpServletRequest request, HttpServletResponse response, HttpServlet servlet) throws ServletException, IOException{
		String respuesta = "";
		PersistenceManager pm = PMF.get().getPersistenceManager();
		if (LogController.isLogged()){
			User usuario = LogController.getUser();
