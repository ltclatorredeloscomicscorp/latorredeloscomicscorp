...
public class Lab10_20172129Servlet2 extends HttpServlet{
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		
		// Company's name and e-mail 
		String senderEmail = "pier9806@gmail.com";
		...
		// message
		String message = "Usted ahora tiene acceso a "+req.getParameter("access");
		...
		resp.setContentType("text/html");
		resp.getOutputStream().println(" HECHO ");
	}
} 
